          ...
          <div class="b__browser--content_right">
            <div class="b__dropdown text-right">
              <label>Sắp xếp <span class="mobile-hidden">theo sản phẩm</span></label>
                <select id="browse-orders" name="url" onchange="orderBy()">
                    <option value="/{{$categorie->url}}" >Sản phẩm mới nhất</option>
                    <option value="/{{$categorie->url}}?price=asc" >Giá tăng dần</option>
                    <option value="/{{$categorie->url}}?price=desc" >Giá giảm dần</option>
                    <!-- <option value="/{{$categorie->url}}" >Mua nhiều nhất</option> -->
