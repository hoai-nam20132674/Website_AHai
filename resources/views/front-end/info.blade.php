									                                	...
									                                	<div class="row">
									                            			<div class="col-md-6">
											                                    <div class="form-group"  >
											                                        ...
											                                        <input class="form-control" placeholder="Nhập họ tên" data-counter="120" value="{{Auth::user()->name}}" name="name" type="text" required id="name">
											                                    </div>
											                                ...
											                                <div class="col-md-6">
											                                    <div class="form-group"  >
											                                        ...
											                                        <label for="name_s" class="control-label ">Tên cửa hàng</label>
											                                        <input class="form-control" placeholder="Nhập tên gian hàng" data-counter="120" value="{{Auth::user()->name_s}}" name="name_s" type="text" required id="name_s">
											                                    </div>
											                            ...
											                            <div class="row">
									                            			<div class="col-md-6">
											                                    <div class="form-group"  >
											                                        ...
											                                        <input disabled class="form-control" placeholder="Nhập sđt" data-counter="120" value="{{Auth::user()->phone}}" name="phone" type="text" required id="phone">
											                                    </div>
											                            ...
											                            <div class="row">
											                            	<div class="col-md-12">
											                            		<div class="form-group"  >
											                                        ...
											                                        <input class="form-control" placeholder="Nhập địa chỉ cửa hàng" data-counter="120" value="{{Auth::user()->address}}" name="address" type="text" id="address">
											                                    </div>
