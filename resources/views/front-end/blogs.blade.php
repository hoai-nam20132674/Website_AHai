...
@section('meta')
	...
	<meta property="og:image" content="{{asset('uploads/images/categories/'.$blog_cate->avata)}}">
...
@section('css')
	...
	<link rel="preload" as='style'  type="text/css" href="{{asset('css/blog_article_style.scss.css')}}">
	<link href="{{asset('css/blog_article_style.scss.css')}}" rel="stylesheet" type="text/css" />
@endsection
@section('content')
				...
				<div class="clearfix group_tagprice product_convert">
					<div class="flexbreadcrumb clearfix">
						...
						<ul class="breadcrumb clearfix a-center">					
							...
							<li><strong><span>{{$blog_cate->name}}</span></strong><li>
