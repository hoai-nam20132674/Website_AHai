              ...
              <div class="b__form--select">
                <div class="voso--custom-select">
                  <select id="browse-order">
                    <option value="xem-nhieu" url="/thoi-trang-nu-c104?order=xem-nhieu">Xem nhiều nhất</option>
                    <option value="thap-nhat" url="/thoi-trang-nu-c104?order=thap-nhat">Giá thấp nhất</option>
                    <option value="moi-nhat" url="/thoi-trang-nu-c104?order=moi-nhat">Mới nhất</option>
                    <option value="cao-nhat" url="/thoi-trang-nu-c104?order=cao-nhat">Giá cao nhất</option>
                    <option value="mua-nhieu" url="/thoi-trang-nu-c104?order=mua-nhieu">Mua nhiều nhất</option>
                    <option value="freeship" url="/thoi-trang-nu-c104?order=freeship">Miễn phí vận chuyển</option>
                  </select>
                </div>
              </div>
            </div>
