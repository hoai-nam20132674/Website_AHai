...
<div class="page-content ">
	<ol class="breadcrumb">
		...
		<li class="breadcrumb-item active">Thêm slider mới</li>
	</ol>


	<div class="clearfix"></div>
	<div id="main">
		<form method="POST" action="{{URL::route('postAddSlider')}}" enctype="multipart/form-data" accept-charset="UTF-8" id="form_1aa3f76ebce588e61c3b18ff42edfa1a">
