...
@section('content')
    <div class="page-content ">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Sửa thẻ bảo hành</li>
        ...
        <div id="main">
            <form method="POST" action="{{URL::route('postEditCard',$card->id)}}" accept-charset="UTF-8" id="form_56d0a8f2e8c8165e444275f5c4091d06">
                            ...
                            <div class="form-body">
                                <div class="row">
                                    <div class="form-group col-md-12"  >
                                        ...
                                        <input class="form-control" data-counter="30" name="name" type="text" value="{{$card->name}}" id="name">
                                    </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6"  >
                                        ...
                                        <input class="form-control" data-counter="30" name="code" type="text" value="{{$card->code}}" required id="code">
                                    </div>
                                    <div class="form-group col-md-6"  >
                                        
                                        <label for="type" class="control-label">Loại thẻ</label>
                                        <input class="form-control" placeholder="Thẻ VIP ..." data-counter="60" name="type" value="{{$card->type}}" type="text" id="type">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6"  >
                                        ...
                                        <input class="form-control" data-counter="60" name="dental" type="text" value="{{$card->dental}}" id="dental">
                                    </div>
                                    <div class="form-group col-md-6"  >
                                        
                                        <label for="labo" class="control-label">Labo</label>
                                        <input class="form-control" data-counter="60" name="labo" type="text" value="{{$card->labo}}" id="labo">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6"  >
                                        ...
                                        <input class="form-control" data-counter="60" name="tooth" type="text" value="{{$card->tooth}}" id="tooth">
                                    </div>
                                    <div class="form-group col-md-6"  >
                                        
                                        <label for="time" class="control-label required">Thời gian bảo hành</label>
                                        <input class="form-control" data-counter="60" required name="time" type="text" value="{{$card->time}}" id="time">
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                            </div>
